  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar-right" style={{display:"flex", alignItems:"center", gap:10}}>
        ...
        <div onClick={toggleThemeMode} style={{width:36, height:36, background:C.card, border:`1px solid ${C.border}`, borderRadius:8, display:"flex", alignItems:"center", justifyContent:"center", cursor:"pointer", color:"var(--mv-muted)"}} title="Toggle theme">
          {isDark ? (
